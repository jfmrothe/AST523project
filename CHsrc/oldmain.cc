...
int main(int argc, char *argv[])
{
    ...
    /*++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    /* CH comments: 
     * this initialization part is not well designed, since  
     * everything is initialized the same way, should just put 
     * the for roup some where else
     * A new class include Points*pts[N] as its private valuables, 
     * and take param_names, prior_types... as initial arguments.
     * */
    Point *pts[N]; 
    for(int j=0; j<N; j++)
    {
    ...
    //
    /*+++++++++++++++++++++++++BEGIN CHELSEA COMMENTS+++++++++++++++++++++*/
    /*this should not appear in main.c as well*/
    double logZ = -DBL_MAX;
